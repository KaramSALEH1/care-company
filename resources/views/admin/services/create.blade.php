...
<section class="bg-white rounded-none shadow-lg p-10 w-full">
    <h1 class="text-3xl font-extrabold text-blue-800 mb-6">Add New Service</h1>
    <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <button type="submit" class="w-full bg-blue-700 text-black px-6 py-2 rounded-full font-semibold shadow hover:bg-blue-800 transition">Create Service</button>
