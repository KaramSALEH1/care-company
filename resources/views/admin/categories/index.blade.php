...
@section('content')
    <div class="max-w-7xl mx-auto py-8 px-4">
        ...
        <div class="mb-8 flex justify-between items-center">
            ...
            <div class="flex flex-wrap gap-3 mb-6">
                ...
                <a href="{{ route('admin.services.index') }}" class="inline-flex items-center px-5 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white font-semibold rounded-lg shadow-md hover:from-green-700 hover:to-green-800 transition-all duration-200 transform hover:-translate-y-0.5">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <tr class="hover:bg-blue-50 transition-colors duration-150 group">
                                <td class="py-4 px-6">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10 bg-blue-100 rounded-xl flex items-center justify-center group-hover:bg-blue-200 transition-colors duration-150">
                                ...
                                <td class="py-4 px-6">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-800 font-mono">{{ $category->slug }}</span>
                                </td>
                                <td class="py-4 px-6">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-700">
                            ...
                            <span class="font-semibold">{{ $categories->total() }}</span> results
                        </p>
                    </div>
                    <div>
                        {{ $categories->links() }}
        ...
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-2xl bg-white">
            <div class="mt-3 text-center">
                ...
                <p class="text-sm text-gray-500 mb-6">
                    Are you sure you want to delete "<span id="categoryName" class="font-semibold text-gray-900"></span>"? This action cannot be undone.
                </p>
    ...
    <script>
            ...
            fetch('{{ route('admin.categories.create') }}')
                ...
                .then(html => {
                    ...
                    if (formSection) {
                        ...
                        const cancelLink = content.querySelector('a[href*="categories.index"]');
                        if (cancelLink) {
                            cancelLink.href = 'javascript:void(0)';
                            cancelLink.onclick = () => closeModal('createModal');
                        }

                        // Re-initialize slug generation
        ...
        // Initialize slug generation for dynamically loaded forms
